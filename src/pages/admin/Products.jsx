...
const Products = () => {
  ...
  const handleEdit = (product) => {
    ...
    if (product.image_path) {
      setImagePreview(`https://api-inventory.isavralabel.com/dessertmeltiq/uploads/${product.image_path}`);
    }
                          ...
                          <div className="flex-shrink-0 h-12 w-12">
                            {product.image_path ? (
                              <img
                                ...
                                src={`https://api-inventory.isavralabel.com/dessertmeltiq/uploads/${product.image_path}`}
                                alt={product.name}
                              />
                            ) : (
