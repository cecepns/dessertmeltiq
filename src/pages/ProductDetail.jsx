      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div data-aos="fade-right">
            <div className="mb-4">
              <img
                src={product.image_path ? `https://api-inventory.isavralabel.com/dessertmeltiq/uploads/${product.image_path}` : 'https://images.pexels.com/photos/209206/pexels-photo-209206.jpeg?auto=compress&cs=tinysrgb&w=800'}
                alt={product.name}
