...
const About = () => {
  ...
  const defaultAboutContent = `DESSERTMELTIQ dimulai dari sebuah toko kecil di sudut kota dengan misi sederhana: 
membuat dessert terbaik untuk keluarga Indonesia. Pendiri kami memulai perjalanan 
ini dengan resep warisan keluarga yang telah diwariskan dari generasi ke generasi.
...
Indonesia. Setiap dessert yang kami buat adalah hasil dari dedikasi dan passion 
  ...
  return (
    <div className="min-h-screen pt-16">
      ...
      <section className="bg-gradient-to-r from-primary-50 to-cream-50 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center" data-aos="fade-up">
            <h1 className="text-4xl md:text-5xl font-bold text-primary-800 mb-6 font-display">
              Tentang {companyName}
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div data-aos="fade-right">
              <img
                src={Logo}
                alt="Pembuat dessert tradisional"
      ...
      <section className="py-20 bg-cream-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16" data-aos="fade-up">
            <h2 className="text-3xl font-bold text-primary-800 mb-4 font-heading">
              Nilai-Nilai Kami
            </h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16" data-aos="fade-up">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Dibalik setiap dessert lezat, ada tim berpengalaman yang bekerja dengan penuh dedikasi
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center" data-aos="fade-up" data-aos-delay="0">
              ...
              <p className="text-gray-600 text-sm">
                Ahli pembuat dessert dengan pengalaman lebih dari 20 tahun, 
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center" data-aos="fade-up">
            <h2 className="text-3xl font-bold text-primary-800 mb-8 font-heading">
              Misi Kami
            </h2>
