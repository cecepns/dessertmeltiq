...
const Contact = () => {
  ...
  const [settings, setSettings] = useState({
    company_name: "DESSERTMELTIQ",
    email: "info@dessertmeltiq.com",
    phone: "+62 123 456 789",
    address: "Jl. Dessert Manis No. 123, Jakarta",
    instagram: "@dessertmeltiq",
    about_us: "",
            ...
            <div data-aos="fade-left">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 whitespace-pre-line">
                      {settings.address || "Jl. Dessert Manis No. 123, Jakarta"}
                    </p>
                  </div>
                </div>
              ...
              <div className="mt-8">
                ...
                <button
                  onClick={() => {
                    const cleanPhone = settings.phone.replace(/[\s+\-()]/g, "");
                    const whatsappUrl = `https://wa.me/${cleanPhone}?text=Halo, saya ingin bertanya tentang produk DESSERTMELTIQ`;
                    window.open(whatsappUrl, "_blank");
                  }}
