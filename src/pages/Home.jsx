      ...
      setFeaturedProducts([
        {
          ...
          price: 15000,
          image_path: null,
          description: "Cheesecake lembut dengan tekstur yang sempurna",
        },
        {
          id: 2,
          ...
          price: 25000,
          image_path: null,
          description: "Tiramisu lezat dengan cita rasa kopi premium",
        },
        {
          id: 3,
          ...
          price: 12000,
          image_path: null,
          description: "Lava cake dengan cokelat meleleh yang menggoda",
        },
      ]);
    } finally {
      setLoading(false);
    ...
    <div className="min-h-screen pt-20">
      ...
      >
        ...
        <div className="relative z-10 text-center px-4">
          <h1
            className="text-5xl md:text-7xl font-bold text-white mb-6 drop-shadow-lg font-display"
            data-aos="fade-up"
          >
            DESSERTMELTIQ
          </h1>
          <p
            className="text-xl md:text-3xl text-white mb-8 max-w-2xl mx-auto drop-shadow-md font-serif italic tracking-wide"
            data-aos="fade-up"
            data-aos-delay="200"
          >
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16" data-aos="fade-up">
            <h2 className="text-4xl font-bold text-primary-800 mb-4 font-heading">
              Produk Unggulan
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto font-sans">
              Temukan berbagai dessert lezat dan berkualitas tinggi yang dibuat
                ...
                >
                  <div className="aspect-square overflow-hidden">
                    <img
                      src={
                        product.image_path
                          ? `https://api-inventory.isavralabel.com/dessertmeltiq/uploads/${product.image_path}`
                  ...
                  <div className="p-6">
                    <h3 className="text-xl font-semibold text-primary-800 mb-2 font-heading">
                      {product.name}
                    </h3>
                    <p
      ...
      <section className="py-20 bg-cream-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16" data-aos="fade-up">
            <h2 className="text-4xl font-bold text-primary-800 mb-4 font-heading">
              Mengapa Pilih DESSERTMELTIQ?
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto font-sans">
              Komitmen kami adalah memberikan dessert berkualitas terbaik dengan
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center" data-aos="fade-up" data-aos-delay="0">
              ...
              <h3 className="text-xl font-semibold text-primary-800 mb-4 font-heading">
                Bahan Premium
              </h3>
            ...
            >
              ...
              <p className="text-gray-600">
                Resep turun temurun yang telah terbukti menghasilkan dessert dengan
                cita rasa autentik
              </p>
            </div>
      ...
      <section className="py-20 bg-primary-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold text-white mb-6 font-heading" data-aos="fade-up">
            Rasakan Kelezatan DESSERTMELTIQ
          </h2>
          <p
            className="text-xl text-cream-100 mb-8 max-w-2xl mx-auto font-sans"
            data-aos="fade-up"
            data-aos-delay="200"
          >
            Kunjungi toko kami atau hubungi untuk pemesanan. Nikmati dessert lezat
            berkualitas tinggi!
          </p>
          <div
            className="space-y-4 md:space-y-0 md:space-x-4 md:flex md:justify-center"
