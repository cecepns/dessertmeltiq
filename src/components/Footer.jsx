    ...
    <footer className="bg-primary-800 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold font-display">DESSERTMELTIQ</span>
            </div>
            <p className="text-cream-200 mb-4 font-serif italic text-lg">
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4 font-heading">Menu</h3>
            <ul className="space-y-2">
              <li><a href="/" className="text-cream-200 hover:text-white transition-colors">Home</a></li>
              <li><a href="/products" className="text-cream-200 hover:text-white transition-colors">Products</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-cream-200">
              <li>
                <a 
                  href="https://www.instagram.com/dessertmeltiq?igsh=MWI3azlzOGtqd2xodA==" 
                  target="_blank" 
                ...
                >
                  ...
                  <span>@dessertmeltiq</span>
                </a>
              </li>
              {/* <li>
                <a 
                  href="https://maps.app.goo.gl/VWFY7FH56u5HFRAL9?g_st=iw" 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="flex items-center gap-2 hover:text-white transition-colors group"
                >
        ...
        <div className="border-t border-primary-700 mt-8 pt-8 text-center">
          <p className="text-cream-200">&copy; 2025 DESSERTMELTIQ. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
